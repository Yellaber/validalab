...
- **WHEN** un usuario autenticado lista las entrevistas filtrando por `estadoScoring` `pendiente`
- **THEN** la respuesta incluye solo las entrevistas cuyo scoring está `pendiente`
...
- **THEN** la respuesta es `200` con la `Entrevista` conservando su `estadoScoring`
